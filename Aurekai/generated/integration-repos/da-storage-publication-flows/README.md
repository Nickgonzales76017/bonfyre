# DA/storage publication flows

Standalone Aurekai integration scaffold for DA/storage publication flows.

## Target Profile

- Slug: da-storage-publication-flows
- Repo name: aurekai-integration-da-storage-publication-flows
- Package name: @aurekai/integration-da-storage-publication-flows
- Surfaces: observer
