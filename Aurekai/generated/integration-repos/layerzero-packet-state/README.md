# LayerZero packet state

Standalone Aurekai integration scaffold for LayerZero packet state.

## Target Profile

- Slug: layerzero-packet-state
- Repo name: aurekai-integration-layerzero-packet-state
- Package name: @aurekai/integration-layerzero-packet-state
- Surfaces: observer
