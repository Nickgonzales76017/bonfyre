# The Graph indexing snapshots

Standalone Aurekai integration scaffold for The Graph indexing snapshots.

## Target Profile

- Slug: the-graph-indexing-snapshots
- Repo name: aurekai-integration-the-graph-indexing-snapshots
- Package name: @aurekai/integration-the-graph-indexing-snapshots
- Surfaces: observer
