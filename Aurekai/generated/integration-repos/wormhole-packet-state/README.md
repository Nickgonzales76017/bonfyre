# Wormhole packet state

Standalone Aurekai integration scaffold for Wormhole packet state.

## Target Profile

- Slug: wormhole-packet-state
- Repo name: aurekai-integration-wormhole-packet-state
- Package name: @aurekai/integration-wormhole-packet-state
- Surfaces: observer
