# LayerZero/Wormhole/Hyperlane packet state

Standalone Aurekai integration scaffold for LayerZero/Wormhole/Hyperlane packet state.

## Target Profile

- Slug: layerzero-wormhole-hyperlane-packet-state
- Repo name: aurekai-integration-layerzero-wormhole-hyperlane-packet-state
- Package name: @aurekai/integration-layerzero-wormhole-hyperlane-packet-state
- Surfaces: observer
