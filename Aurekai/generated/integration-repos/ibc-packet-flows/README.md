...
Standalone Aurekai integration scaffold for IBC packet flows.

## Target Profile

- Slug: ibc-packet-flows
- Repo name: aurekai-integration-ibc-packet-flows
- Package name: @aurekai/integration-ibc-packet-flows
- Surfaces: observer
